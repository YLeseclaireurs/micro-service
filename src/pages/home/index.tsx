...
import { IconFile, IconGlobe, IconHelpCircle,IconInfoCircle,IconCamera } from '@douyinfe/semi-icons';
          ...
          <div className={styles.content}>
              <div class={styles.head}>
                  <div className={styles.box}>
                      <Avatar size="default" hoverMask={hover} alt='栗的博客'>栗</Avatar>
                      <span className={styles.sign}>&nbsp;&nbsp;栗 · 若能虚己以游世，其孰能害之</span><br/>
                  </div>
              </div>
              <Tabs>
                  <TabPane tab={<span><IconInfoCircle />主页</span>} itemKey="1">
                      文档
                  </TabPane>
                  <TabPane tab={<span><IconGlobe />发现</span>} itemKey="2">
                      快速起步
                  </TabPane>
                  <TabPane tab={<span><IconHelpCircle />帮助</span>} itemKey="3">
                      帮助
                  </TabPane>
              </Tabs>
          </div>
