...
import { List,Tabs, TabPane, Avatar} from '@douyinfe/semi-ui';
import { IconFile, IconGlobe, IconHelpCircle,IconInfoCircle,IconCamera,IconGridView } from '@douyinfe/semi-icons';
import { HomeOutlined,DribbbleOutlined,HeartOutlined,FolderOutlined } from '@ant-design/icons';
          ...
          <div className={styles.content}>
              <div className={styles.head}>
                  <div className={styles.box}>
                      <Avatar color="red" size="small" hoverMask={hover} alt='栗的博客'>栗</Avatar>
                      <span className={styles.sign}>&nbsp;&nbsp;栗 · 若能虚己以游世，其孰能害之</span><br/>
                  </div>
              </div>
              <Tabs>
                  <TabPane tab={<span><HeartOutlined />&nbsp;主页</span>} itemKey="1">
                      文档
                  </TabPane>
                  <TabPane tab={<span><DribbbleOutlined />&nbsp;发现</span>} itemKey="2">
                      快速起步
                  </TabPane>
                  <TabPane tab={<span><FolderOutlined />&nbsp;Maps</span>} itemKey="3">
